...
const PlanForLaterCard = () => {
  return (
    <>
    <div className="w-full lg:max-w-7wl rounded-3xl overflow-hidden relative bg-[rgb(157,205,214)]">
      <div className="p-8 lg:p-12 relative z-10">
        <div className="mt-8 space-y-6 max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative">
                ...
                <Input type="text" placeholder="Date" className="pl-10 h-12 bg-white/90 border-0" />
              </div>
              <Select>
          ...
          <Button className="w-full h-12 bg-black text-white hover:bg-black/90">Next</Button>
        </div>
      </div>
